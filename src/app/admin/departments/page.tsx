...
export default function DepartmentsPage() {
  ...
  const renderTableRow = (department: Department) => (
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-md h-12 px-6 bg-gray-800 text-white text-base font-bold leading-normal tracking-[0.015em] shadow-[0_1px_2px_rgba(0,0,0,0.05),0_2px_4px_rgba(0,0,0,0.0.1)] transition-all hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-2 focus:ring-offset-gray-900"
              >
                  ...
                  {loading ? (
                    ...
                    <>
                      <tr className="hover:bg-gray-900">
                        ...
                        <td className="py-4 px-6">CS101, CS202, CS350</td>
                        <td className="py-4 px-6">452</td>
                        <td className="py-4 px-6 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button
                      ...
                      <tr className="hover:bg-gray-900">
                        ...
                        <td className="py-4 px-6">MATH101, MATH203, STAT301</td>
                        <td className="py-4 px-6">210</td>
                        <td className="py-4 px-6 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              onClick={() => setShowEditModal(true)}
                      ...
                      <tr className="hover:bg-gray-900">
                        ...
                        <td className="py-4 px-6">EE101, EE220, EE345</td>
                      ...
                      <tr className="hover:bg-gray-900">
                        ...
                        <td className="py-4 px-6">PHYS101, PHYS210, PHYS305</td>
                      ...
                      <tr className="bg-green-900/20 text-green-400">
                        <td className="whitespace-nowrap py-4 px-6 font-medium">Mechanical Engineering added successfully.</td>
                        <td className="py-4 px-6"></td>
                        <td className="py-4 px-6"></td>
                        <td className="py-4 px-6 text-right">
                          <button className="flex items-center justify-center rounded-md p-2 text-green-400 hover:bg-green-800/50">
                            <svg className="h-4 w-4" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="rounded-lg border border-gray-800 bg-gray-950 p-6">
                <form className="space-y-8">
                  ...
                  <div className="flex justify-end gap-4 pt-6 border-t border-gray-800">
                    ...
                    <button
                      className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-md h-12 px-6 bg-blue-600 text-white text-base font-bold leading-normal tracking-[0.015em] shadow-[0_1px_2px_rgba(0,0,0,0.05),0_2px_4px_rgba(0,0,0,0.0.1)] transition-all hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                      type="submit"
                    >
                      Save Changes
                    </button>
