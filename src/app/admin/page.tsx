        ...
        <main className="flex flex-1 flex-col p-8">
          ...
          <div className="flex w-full flex-col gap-8 @container">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="flex flex-col gap-2 rounded-md border border-gray-800 bg-gray-950 p-6">
                <p className="text-gray-400 text-sm font-normal leading-normal">Total Moderators</p>
                <p className="text-white tracking-tight text-4xl font-bold leading-tight">25</p>
              </div>
              <div className="flex flex-col gap-2 rounded-md border border-gray-800 bg-gray-950 p-6">
